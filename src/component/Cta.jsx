...
export default function Cta() {
  ...
  return (
    <>
      <div
        id="contact"
        className="relative z-10 w-full min-h-max px-6 sm:px-8 md:px-16 py-8 lg:py-14  bg-[#F6F5F0]"
      >
        <div className="grid items-center justify-center container max-w-7xl mx-auto ">
          <AnimatedText triggerOnScroll>
            <h2 className="text-2xl md:text-4xl font-semibold text-[#0F0F0F] mb-6">
            ...
            <div>
              <AnimatedText triggerOnScroll>
                <div className="flex-col items-center justify-between lg:max-h-7xl ">
                  <p className="text-[15px] sm:text-[17px] mb-6 lg:mb-8">
                    Open to full–time roles, freelance work, or meaningful
                    collaborations.
                  </p>
                  <p className="text-[15px] sm:text-[17px]">
                    If you’re looking for someone who writes clean code, thinks
                    in components, and cares about the user — I’d be glad to
                    connect.
                  </p>
